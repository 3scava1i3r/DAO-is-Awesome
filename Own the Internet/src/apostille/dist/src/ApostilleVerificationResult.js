...
class ApostilleVerificationResult {
    constructor(code, result, message, metadata) {
        this.code = code;
        this.result = result;
     ...
     */
    static create(code, result, metadata = undefined) {
        const messages = {
...
exports.ApostilleVerificationResult = ApostilleVerificationResult;
//# sourceMappingURL=ApostilleVerificationResult.js.map